...
class CustomPopupMenu(
    ...
    var onChangeItemNote: ((com.easynote.domain.models.Note) -> Unit)? = null
    var onChangeItemToolbar: ((Boolean) -> Unit)? = null

    var onChangeItemNoteDelete: ((com.easynote.domain.models.Note) -> Unit)? = null
    var onChangeItemNoteCategory: ((com.easynote.domain.models.Note) -> Unit)? = null
    var onChangeItemNoteArchive: ((com.easynote.domain.models.Note) -> Unit)? = null
    var onItemCrypt: ((com.easynote.domain.models.Note) -> Unit)? = null
    var onItemPas: (() -> Unit)? = null

    var onChangeItemCategory: ((com.easynote.domain.models.Category) -> Unit)? = null
    var onDeleteItemCategory: ((com.easynote.domain.models.Category) -> Unit)? = null

    private fun setCheckableMenuItem(
        isSelected: Boolean,
        checkable: com.easynote.domain.models.ChangeMenuItem,
        itemId: Int
    ): MenuItem {
        var title = ""
    ...
    fun showPopupMenuNoteItem(selectedNote: com.easynote.domain.models.Note, isOpened: Boolean) {
        val hashMap = HashMap<Int, com.easynote.domain.models.ChangeMenuItem>()
        hashMap[0] = com.easynote.domain.models.ChangeMenuItem(
            R.drawable.ic_push_pin_24,
            "Pin",
            R.drawable.ic_delete,
            "Unpin"
        )
        hashMap[1] = com.easynote.domain.models.ChangeMenuItem(
            R.drawable.ic_favorite,
            "Add to favorite",
            R.drawable.ic_favorite_sold,
            "Delete from favorite"
        ...
        hashMap[2] = com.easynote.domain.models.ChangeMenuItem(
            R.drawable.ic_arch,
            "Add to archive",
    ...
    fun showPopupMenuToolbar(isSelect: Boolean) {
        val changeItem = com.easynote.domain.models.ChangeMenuItem(
    ...
    fun showPopupMenuArchive(selectedNote: com.easynote.domain.models.Note) {
        menuInflater.inflate(
    ...
    fun showPopupMenuBinItem(currentNote: com.easynote.domain.models.Note) {
        menuInflater.inflate(
            R.menu.menu_filter_list_fragment,
            menu
        )
    ...
    fun showPopupMenuCategoryItem(selectedCategory: com.easynote.domain.models.Category) {
        menuInflater.inflate(
