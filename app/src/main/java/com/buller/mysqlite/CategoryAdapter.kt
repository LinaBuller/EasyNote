...
//
    class CategoryHolderRead(itemView: View) : RecyclerView.ViewHolder(itemView) {
...
//                contextActivity.setIntentToMainActivity(category.id.toInt())
//            }
//
...
//                EditTextChangeToTextAndBackToEditText.editTextToText(etTitleCategory)
//                category.title = etTitleCategory.text.toString()
...
//                        parent,
//                        false
//                    ), context as AppCompatActivity,passIdAndTitleCategoryToCAS
//                )
//            }
//            ContentConstants.READ_CATEGORY -> {
...
//                        parent,
//                        false
//                    ), context as AppCompatActivity,passIdCategoryToCA
//                )
//            }
//        }
//        return CategoryHolderSelect(
