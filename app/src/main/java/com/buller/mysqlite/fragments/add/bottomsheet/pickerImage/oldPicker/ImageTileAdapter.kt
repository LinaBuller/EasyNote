...
sealed class VHImageTileBase(
    ...
    class VHImageTile(view: View) : VHImageTileBase(view) {
        ...
        fun update(
            ...
            Glide.with(ivImage).load(uri).error(R.drawable.ic_broken_image_glade).into(ivImage)
        }
    }
    ...
    class VHGalleryTile(view: View, clickListener: () -> Unit) : VHImageTileBase(view) {
        init {
            ...
            view.findViewById<ImageView>(R.id.ivIcon).setImageResource(R.drawable.ic_gallery_tile_imagepicker_add_fragment)
        }
    }
    ...
    class VHCameraTile(view: View, clickListener: () -> Unit) : VHImageTileBase(view) {
        init {
            view.setOnClickListener { clickListener.invoke() }
            view.findViewById<ImageView>(R.id.ivIcon).setImageResource(R.drawable.ic_camera_tile_imagepiker_add_fragment)
        }
    }
}